...
# Function to load R simulation data
function load_simulation_gertheiss(simulation_name, simulation_settings_file, project_root; predictors, observations=nothing, measurements=nothing, basis_functions=nothing, noise_snr=nothing, seed=nothing, phi=nothing)
    # clear R environment
    # load new simulation data
